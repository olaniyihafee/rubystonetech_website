...
/* Used to change make the navbar menu colapse once a link in it is clicked*/
$("#sidebarMenu a:not(#servicesMenuLink)").click(function() {
  console.log('It runs navbar menu clicked')
  $("#sidebarMenu").collapse("hide");
});

/* Used to change color of the navbar on scroll */
$(function () {
  $(document).scroll(function () {
    console.log('It runs navbar color change')
